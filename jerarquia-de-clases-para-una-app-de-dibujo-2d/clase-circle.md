...
<table><thead><tr><th width="110.1875">Nombre</th><th width="136.51953125">Tipo</th><th width="143.91796875">Visibilidad</th><th>Descripción</th></tr></thead><tbody><tr><td><code>center</code></td><td>de instancia</td><td>privado</td><td>Centro del círculo (tipo <code>Point2D</code>).</td></tr><tr><td><code>radius</code></td><td>de instancia</td><td>privado</td><td><p>Radio del círculo (tipo <code>float</code>). </p><p></p><p>Debe ser mayor o igual que 0.</p></td></tr></tbody></table>
...
<table><thead><tr><th width="179.421875">Perfil</th><th width="128.2734375">Visibilidad</th><th>Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>__init__(color, center, radius)</code></td><td>-</td><td>Método (constructor) de instancia</td><td><p>Extiende al constructor de la clase base.</p><p></p><p><code>center</code> debe ser un <code>Point2D</code> (si no, lanzará una excepción <code>TypeError</code>), y <code>radius</code> un valor numérico mayor o igual que cero (si no, lanzará una excepción <code>ValueError</code>). </p><p></p><p>Por defecto, el color será "red", el centro (0,0) y radio 1.</p></td></tr><tr><td><code>center()</code></td><td>público</td><td>Propiedad consultora de instancia</td><td>Devuelve el atributo <code>center</code>.</td></tr><tr><td><code>center(p)</code></td><td>público</td><td>Propiedad modificadora de instancia</td><td>Modifica el atributo <code>center</code> con una instancia de <code>Point2D</code> (si no, lanzará una excepción <code>TypeError</code>).</td></tr><tr><td><code>radius()</code></td><td>público</td><td>Propiedad consultora de instancia</td><td>Devuelve el atributo <code>radius</code>.</td></tr><tr><td><code>radius(r)</code></td><td>público</td><td>Propiedad modificadora de instancia</td><td><p>Modifica el atributo <code>radius</code>. </p><p></p><p>Lanzará <code>ValueError</code> cuando corresponda.</p></td></tr><tr><td><code>__eq__(other)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores, método abstracto en <code>Shape</code>)</td><td>Compara si dos círculos son lógicamente idénticos (mismo color, centro y radio).</td></tr><tr><td><code>__hash__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores, método abstracto en <code>Shape</code>)</td><td><p>Método para usar <code>Circle</code> en un <code>set</code>. </p><p></p><p>Puedes retornar el hash de la tupla conteniendo color, y atributos del centro y el radio.</p></td></tr><tr><td><code>__str__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores, método abstracto en <code>Shape</code>)</td><td><p>Devuelve una cadena de texto representando el círculo. </p><p></p><p>Por ejemplo: <code>"Circle(color: red, center: (0.0, 0.0), radius: 1.0)"</code>.</p></td></tr></tbody></table>
