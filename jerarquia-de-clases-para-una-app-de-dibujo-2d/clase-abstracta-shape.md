...
<table><thead><tr><th width="112.76171875">Nombre</th><th width="128.40234375">Tipo</th><th width="119.24609375">Visibilidad</th><th>Descripción</th></tr></thead><tbody><tr><td><code>color</code></td><td>de instancia</td><td>protegido</td><td>Color de la figura (string). Solo podrá ser uno de estos tres valores: "red", "green", "blue".</td></tr><tr><td><code>count</code></td><td>estático</td><td>privado</td><td>Contabilizará el número total de figuras "vivas" (instancias activas). Cada vez que se crea una figura, se incrementa. Cada vez que se elimina (o se recolecta), debe decrementarse.</td></tr></tbody></table>

### Métodos

<table><thead><tr><th width="206.96484375">Perfil</th><th width="125.00390625">Visibilidad</th><th width="164.2421875">Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>__init__(color)</code></td><td>-</td><td>Método (constructor) de instancia</td><td>Crea una figura del color especificado. Por defecto, el color es "red". Lanzará nuestra excepción <strong><code>InvalidFigureError</code></strong> si el color proporcionado no es válido (<em>tip: mejor delega esa gestión en la propiedad setter</em>). Incrementa el contador global de figuras.</td></tr><tr><td><code>__del__()</code></td><td>-</td><td>Método (destructor) de instancia</td><td>Decrementa el contador global de figuras. Se llamará automáticamente cuando el recolector de basura de Python elimine una figura de memoria.</td></tr><tr><td><code>color()</code></td><td>público</td><td>Propiedad consultora de instancia</td><td>Devuelve el color de relleno de la figura.</td></tr><tr><td><code>color(new_color)</code></td><td>público</td><td>Propiedad modificadora de instancia</td><td>Cambia el color de relleno de la figura. Lanzará la excepción <strong><code>InvalidFigureError</code></strong> si el color no es <code>"red"</code>, <code>"green"</code>, o <code>"blue"</code>.</td></tr><tr><td><code>count()</code></td><td>público</td><td>Método consultor estático</td><td>Devuelve el valor actual de <code>count</code>.</td></tr><tr><td><code>area()</code></td><td>público</td><td>Método de instancia abstracto</td><td>Toda figura concreta deberá implementar el cálculo de su área.</td></tr><tr><td><code>perimeter()</code></td><td>público</td><td>Método de instancia abstracto</td><td>Toda figura concreta deberá implementar el cálculo de su perímetro.</td></tr><tr><td><code>translate(incX, incY)</code></td><td>público</td><td>Método de instancia abstracto</td><td>Toda figura concreta deberá implementar el desplazamiento de la figura sobre el espacio de representación, aplicando los incrementos de X e Y proporcionados.</td></tr><tr><td><code>__eq__(other)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores) abstracto</td><td>Comprueba si dos figuras son lógicamente iguales. Toda figura concreta deberá implementarla.</td></tr><tr><td><code>__ne__(other)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td>Compara si dos figuras son lógicamente diferentes delegando convencionalmente en <code>__eq__</code>. Notar que es un método <strong>concreto</strong> que heredarán todas las clases derivadas.</td></tr><tr><td><code>__hash__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores) abstracto</td><td>Hace que el objeto sea "hasheable" (p.ej., uso en operaciones de conjuntos, uso como clave en diccionarios). Toda figura concreta deberá implementarla.</td></tr><tr><td><code>__str__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores) abstracto</td><td>Toda figura concreta deberá implementar su representación en cadena de texto.</td></tr><tr><td><code>__repr__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td>Delega convencionalmente en <code>__str__</code>. Notar que es un método <strong>concreto</strong>: estamos estipulando que, en todas las clases derivadas, <code>__repr__</code> delegará en su implementación de <code>__str__</code> concreta.</td></tr></tbody></table>
