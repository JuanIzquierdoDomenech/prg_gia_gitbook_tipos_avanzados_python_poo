...
<table><thead><tr><th width="172.34375">Perfil</th><th width="121.4609375">Visibilidad</th><th width="176.90234375">Tipo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>__init__(x, y)</code></td><td>-</td><td>Método (constructor) de instancia</td><td><p>Por defecto, las coordenadas <code>x</code> e <code>y</code> tomarán el valor 0. </p><p></p><p>Deberá comprobar que los valores proporcionados son floats o se pueden convertir a float. De lo contrario, lanzará una excepción <code>ValueError</code>.</p></td></tr><tr><td><code>distance(a, b)</code></td><td>público</td><td>estático</td><td>Calcula la distancia euclidiana entre dos objetos <code>Point2D</code> <code>a</code> y <code>b</code>.</td></tr><tr><td><code>__eq__(other)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td><p>Sobrecarga del comparador de igualdad <code>==</code>. </p><p></p><p>Comprueba si dos puntos son lógicamente iguales. </p><p></p><p>Devolverá <code>False</code> si <code>other</code> no es un <code>Point2D</code>.</p></td></tr><tr><td><code>__ne__(other)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td><p>Sobrecarga del comparador de desigualdad <code>!=</code>. </p><p></p><p>Comprueba si dos puntos son diferentes. </p><p></p><p>Puedes delegar en <code>__eq__</code>, pero asegúrate antes que se devuelva <code>False</code> si <code>other</code> no es un <code>Point2D</code>.</p></td></tr><tr><td><code>__hash__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td><p>Permite que el objeto sea <em>hashable</em>. </p><p></p><p>Al implementar este método junto a <code>__eq__</code>, podemos introducir objetos <code>Point2D</code> en colecciones tipo conjunto (<code>set</code>) para, por ejemplo, eliminar duplicados fácilmente.</p></td></tr><tr><td><code>__getitem__(key)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td><p>Permite obtener la coordenada <code>x</code> si el índice (<code>key</code>) devuelto es <code>0</code>, <code>"x"</code> o <code>"X"</code>, y la coordenada <code>y</code> si es <code>1</code>, <code>"y"</code> o <code>"Y"</code>. </p><p></p><p>Para claves no válidas, lanza una excepción <code>KeyError</code> con un mensaje descriptivo.</p></td></tr><tr><td><code>__setitem__(key, value)</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td>Permite modificar la coordenada <code>x</code> o <code>y</code> según la misma lógica de índices especificada en <code>__getitem__</code>.</td></tr><tr><td><code>__str__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td><p>Sobrecarga de la conversión a cadena (análogo a <code>toString()</code>). </p><p></p><p>Devolverá una representación legible del punto, por ejemplo: <code>"(1.5, -2.0)"</code>.</p></td></tr><tr><td><code>__repr__()</code></td><td>-</td><td>Método de instancia (sobrecarga de operadores)</td><td>Funcionalmente equivalente a <code>__str__</code>. Por tanto, delega (convencionalmente) en él.</td></tr></tbody></table>
